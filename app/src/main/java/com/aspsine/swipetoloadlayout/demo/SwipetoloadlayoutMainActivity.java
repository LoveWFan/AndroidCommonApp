...
public class SwipetoloadlayoutMainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_swipetoloadlayout_main);
        ...
        drawerLayout.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (itemId == R.id.nav_about) {
                    startActivity(new Intent(SwipetoloadlayoutMainActivity.this, AboutActivity.class));
                } else {
